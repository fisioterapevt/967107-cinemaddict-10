export const createFilmDetailsTemplate = (filmPopup) => {
  const {name, ageRestricted, poster, director, writer, actor, duration, country, genre, rating, description, countComments} = filmPopup;
  return (
